...
export default function RegisterScreen() {
    ...
    const onSubmit = async () => {
        ...
        if (!pwdCheck.valid) {
            Alert.alert('Mot de passe invalide', 'Votre mot de passe doit respecter les règles indiquées.');
            return;
        }
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text style={{ marginBottom: 6, color: '#374151', fontWeight: '500' }}>Nom d'utilisateur</Text>
                <TextInput
